...
void Application::Setup()
{
	...
	glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, 0, (GLvoid*)(plane.planeBytes));
	...
	uniforms["mModel_id"] = glGetUniformLocation(plane.shader, "mModel");
	...
	GLint id = loadTexture("Assets/Cobble_Norm.jpg");
	if (id > 0) {
...
void Application::Update()
{
	...
	matrixes["mod"] = mouseRotateX * mouseRotateY;
